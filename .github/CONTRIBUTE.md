...
- **`release/*`**: Preparation for a new production release (e.g., `release/v1.1.0`). Branch off `develop`, merge into both `main` and `develop`.
- **`hotfix/*`**: Urgent fixes to production (e.g., `hotfix/crash-on-pdf`). Branch off `main`, merge into both `main` and `develop`.
